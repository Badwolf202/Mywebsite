...
?>
    ...
    <div class="container-fluid text-center">
        <legend><h3 class="h3 mb-3" style="color: white"> Account creation form </h3></legend>
        <form method="post" action="Form_validation.php" class="form-floating">
            <p class="text-center" style="color: white"><strong>First Name:</strong><br>
                <input type="text" name="firstname" required></p>
            <p class="" style="color: white"><strong>Last Name:</strong><br>
                <input type="text"  name="lastname" required></p>
            <p class="" style="color: white"><strong>Email:</strong><br>
